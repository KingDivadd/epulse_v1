        ...
        <div className="w-full flex flex-col gap-5 -mt-2 py-5 rounded-md ">
            <div className="w-full  flex max-sm:flex-col items-center justify-start gap-5 ">
                <div className="w-full  flex items-center gap-3 justify-between sm:justify-start h-[45px]">
                    <button
                        className="h-full rounded-sm duration-150 border border-gray-300 text-sm bg-white hover:bg-[#fafafa] px-7 md:px-3 lg:px-7"
                        onClick={() => setFilter_doctor('General Practice')}>
                        General Doctor
                    </button>
                    <button
                        className="sm:hidden md:block h-full rounded-sm duration-150 border border-gray-300 text-sm bg-white hover:bg-[#fafafa] px-10"
            ...
            <div className="w-full max-h-[800px] overflow-y-auto scrollbar-hidden max-sm:-mt-2 -mt-1 hide-scrollbar">
                ...
                <div className=" w-full flex flex-col gap-5 temp-300 hide-scrollbar">
                    ...
                    return (
                        <div
                        key={physician_id}  className="w-full rounded-md bg-white shadow-md p-3 flex gap-3 cursor-pointer hover:bg-[#306ce9] group  ease-in-out duration-300  "
                        onClick={() => {
                        ...
                        >
                            ...
                            <div className="flex-1 h-full flex flex-col items-start justify-center gap-1 group-hover:text-white">
                                <p className="text-[15px] font-medium">Dr. {first_name} {last_name}</p>
                                <p className="text-[12px] text-green-600 group-hover:text-green-400">Available</p>
