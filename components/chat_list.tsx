    ...
    return (
        <>
            <div className="hidden lg:flex flex-col gap-3  w-full h-full justify-start ">
                <h3 className="font-mont font-semibold text-lg  text-slate-700">{(user_information && user_information.role == 'physician') ? "Patients":"Physicians"}</h3>
                        ...
                        <div className="w-full flex flex-col gap-2">
                            {
                                [1,2,3,4,5,6,7,8].map((data, ind)=>{
                                    return(
                                            <span key={ind} className="flex h-[100px] items-center justify-between gap-3 p-5 bg-white rounded-md shadow-md">
                        ...
                        <div className="w-full flex flex-col gap-2">
                            {
                                [1,2,3,4,5,6,7,8,9,0].map((data,ind)=>{
                                    ...
                                    return(
                                        <div key={ind} className={`w-full h-[80px] sm:h-[90px] ${selected_chat}   rounded-sm shadow-md p-2 sm:p-3 font-mont flex items-center justify-start gap-2 group cursor-pointer`} onClick={()=> {setShow_selected_chat(!show_selected_chat);setSelected(ind); } }>
