...
const AdminAppointmentSchedule = ({ fund_search, setFund_search }: FundSearchProps) => {
            ...
            <div className={`hidden min-w-[1000px] md:flex flex-col items-start justify-start`}>
                <div className="w-full flex items-center justify-between border h-[55px] border-gray-200  ">
                    <div className="w-[30%] px-3 sm:px-5 flex items-center justify-start">
                        <p className="text-[13px] font-medium">Date, Time</p>
                    </div>
                ...
                <div className="w-full bg-white ">
                    {currentTransactions.map((data: TransactionHistoryProps, ind: number) => {
                        ...
                        const transaction_type_style = `px-5 h-[30px] rounded-full flex items-center justify-center border ${
                        ...
                        <div
                            key={transaction_id}
                            className={`w-full flex items-center justify-between py-3 hover:bg-gray-50 ${
                            ind % 2 === 1 ? 'bg-gray-50' : ''
                            }`}
                        >
                            <div className="w-[30%] px-3 sm:px-5 flex items-center justify-start">
